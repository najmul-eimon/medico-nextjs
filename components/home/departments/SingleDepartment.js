  ...
  return (
    <div className="single-department p-4 md:py-4 md:px-14 text-center border-black/5">
      <div className="h-20 md:h-[120px] w-20 md:w-[120px] flex items-center justify-center mx-auto">
        <Image src={icon} width={100} height={100} alt="heart icon"/>
      </div>
      ...
      <Link href="/service" className="mx-auto flex items-center justify-center gap-1 rounded-[5px] py-2 w-[148px] md:w-[135px] text-sm font-semibold text-secondary border border-secondary/20 bg-secondary/10 hover:bg-secondary hover:border-secondary hover:text-white group">
        Read More
